...
export const appFile = (functions, useTs, props) => {
    return {
        name: "App",
        extension: `${useTs ? ".tsx" : ".jsx"}`,
        file: `
...
export const details = (useTs, props) => {
    return {
        name: "Details",
        extension: `${useTs ? ".tsx" : ".jsx"}`,
        file: `
